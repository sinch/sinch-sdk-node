...
export type ManageCallWithCallLegCallLegEnum = 'caller' | 'callee' | 'both';
export interface GetCallResultRequestData {
  /** The unique identifier of the call. This value is generated by the system. */
  'callId': string;
}
export interface ManageCallWithCallLegRequestData {
  /** The unique identifier of the call. This value is generated by the system. */
  'callId': string;
  ...
  'callLeg': ManageCallWithCallLegCallLegEnum;
  /**  */
...
export class CallsApi extends VoiceApi {
   ...
   */
  public async getCallResult(data: GetCallResultRequestData): Promise<GetCallResponseObj> {
   ...
   * @param { ManageCallWithCallLegRequestData } data - The data to provide to the API call.
   */
  public async manageCallWithCallLeg(data: ManageCallWithCallLegRequestData): Promise<void> {
    this.client = this.getSinchClient();
    const getParams = this.client.extractQueryParams<ManageCallWithCallLegRequestData>(data, [] as never[]);
    const headers: { [key: string]: string | undefined } = {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
    };
   ...
   */
  public async updateCall(data: UpdateCallRequestData): Promise<void> {
    this.client = this.getSinchClient();
