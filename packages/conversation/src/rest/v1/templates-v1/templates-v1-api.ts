...
export class TemplatesV1Api extends ConversationDomainApi {
  ...
  public async create(data: CreateTemplateRequestData): Promise<V1Template> {
    ...
    const basePathUrl = `${this.client.apiClientOptions.basePath}/v1/projects/${this.client.apiClientOptions.projectId}/templates`;
  ...
  public async delete(data: DeleteTemplateRequestData): Promise<any> {
    ...
    const body: RequestBody = '';
    const basePathUrl = `${this.client.apiClientOptions.basePath}/v1/projects/${this.client.apiClientOptions.projectId}/templates/${data['template_id']}`;
