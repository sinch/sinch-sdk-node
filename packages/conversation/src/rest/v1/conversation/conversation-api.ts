...
export interface InjectMessageRequestData {
  ...
  'conversationMessageInjectedBody': ConversationMessageInjected;
}
...
export class ConversationApi extends ConversationDomainApi {
   ...
   */
  public async createConversation(data: CreateConversationRequestData): Promise<Conversation> {
   ...
   */
  public async deleteConversation(data: DeleteConversationRequestData): Promise<any> {
    this.client = this.getSinchClient();
   ...
   */
  public async getConversation(data: GetConversationRequestData): Promise<Conversation> {
    this.client = this.getSinchClient();
  ...
  public async injectMessage(data: InjectMessageRequestData): Promise<any> {
    ...
    const body: RequestBody
      = data['conversationMessageInjectedBody'] ? JSON.stringify(data['conversationMessageInjectedBody']) : '{}';
    const basePathUrl = `${this.client.apiClientOptions.basePath}/v1/projects/${this.client.apiClientOptions.projectId}/conversations/{message.conversation_id}:inject-message`;
   ...
   */
  public listConversations(data: ListConversationsRequestData): ApiListPromise<Conversation> {
    this.client = this.getSinchClient();
   ...
   */
  public async stopActiveConversation(data: StopActiveConversationRequestData): Promise<any> {
    this.client = this.getSinchClient();
   ...
   */
  public async updateConversation(data: UpdateConversationRequestData): Promise<Conversation> {
    this.client = this.getSinchClient();
    ...
    const body: RequestBody = data['conversationBody'] ? JSON.stringify(data['conversationBody']) : '{}';
    const basePathUrl = `${this.client.apiClientOptions.basePath}/v1/projects/${this.client.apiClientOptions.projectId}/conversations/${data['conversation_id']}`;
