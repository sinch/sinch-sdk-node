## Version 1.6.0
- [Feature] Support new `CallbackPayloadNumberOrder` event
...
## Version 1.4.1
- [Bugfix] Make the lazyClient public in the NumbersService to be able to override it with a custom one.
